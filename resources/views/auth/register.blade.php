    ...
    <div class="centered-section">
        <div class="main-section-login">
                    ...
                    <form method="POST" id="registrationForm" action="{{ route('register') }}">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div>
                                ...
                                <label for="birth_date" class="col-form-label text-md-right">Data di nascita<span
                                        class="text-danger"> *</span></label>
                                ...
                                <label for="email" class="col-form-label text-md-right">Indirizzo email<span class="text-danger"> *</span></label>
                                ...
                                <label for="password-confirm" class=" col-form-label text-md-right">Conferma password<span class="text-danger"> *</span></label>
                        ...
                        <div class="mt-2">Hai già un account? <a href="{{ route('login') }}">Login</a></div>
                    </form>
                </div>
            ...
            <div class="photo-section-login">
                <img src="{{ asset('img/home-interiors-residential-2020-dezeen-roundups_dezeen_hero-1.jpg') }}"
